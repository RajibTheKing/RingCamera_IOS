...
- (int)InitializeAudioVideoEngineForCall
{
    ...
    iRet = CVideoAPI::GetInstance()->StartVideoCall(sessionID, m_iCameraHeight, m_iCameraWidth, SERVICE_TYPE_CALL, ENTITY_TYPE_CALLER, 0, /*NetworkType*/ 0, /*bIsAudioOnlyLive*/false);
